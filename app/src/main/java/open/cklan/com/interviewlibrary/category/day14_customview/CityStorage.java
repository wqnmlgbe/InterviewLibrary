...
/**
 * AUTHOR：lanchuanke on 17/10/18 08:50
 */
public class CityStorage {
    ...
    public static List<City> getCityList() {
        ...
        final int FU_JIAN_ICON = R.drawable.feed_item_bg;
        ...
        final int AN_HUI_ICON = R.drawable.feed_item_bg;
        ...
        final int ZHE_JIANG_ICON = R.drawable.feed_item_bg;
        ...
        final int JIANG_SU_ICOM = R.drawable.feed_item_bg;
